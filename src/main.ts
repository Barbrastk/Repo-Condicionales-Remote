...
const dameCarta = (): number => {
  ...
  if (numero > 7) numero += 2; // saltar 8 y 9
  return numero;
};

// Función para mostrar carta (simplificado)
const mostrarCarta = (carta: number) => {
  imgCarta.src = "https://raw.githubusercontent.com/Lemoncode/fotos-ejemplos/main/cartas/copas/" + carta + "_copas.jpg";
};
